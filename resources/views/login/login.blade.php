...
<head>
  ...
  <body class="login-body" ng-controller = "login" >
      ...
      <form class="form-signin" ng-submit="submit()">
        ...
        <div class="login-wrap">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
             <input class="form-control" name="nim" placeholder="Masukan NIM Anda" ng-model='data.nim' type="text" data-toggle="tooltip" data-placement="top" title="Masukan NIM Anda">
             <input class="form-control" name="password" placeholder="Masukkan Password Anda" ng-model='data.password' type="password" data-toggle="tooltip" data-placement="top" tite="Masukkan Password Anda">
    ...
    <script src="{{asset('js/hmsiapp/controller/login.js')}}"></script>
