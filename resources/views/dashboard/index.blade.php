...
<html lang="en">
    <head>
        ...
        <title>Dashboard SIMASI 2015</title>
        <!-- Bootstrap core CSS -->
    ...
    <body>
        <section id="container" >
            ...
            <header class="header white-bg navbar-fixed-top">
                ...
                <!--logo start-->
                <a href="index.html" class="logo"><img src="{{ asset('img/logoSI.gif') }}" height="30" width="30"></img> SIMA<span>SI</span></a>
                <!--logo end-->
                    ...
                    <ul class="nav pull-right top-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu extended logout">
                                ...
                                <li><a href="{{ URL::to('users/logout') }}"><i class="icon-key"></i> Log Out</a></li>
                            </ul>
                        </li>
